                ...
                foreach ($todos as $data) {
                    if ($data['status'] == 'completed') {
                        echo '<li class="' . $data['status'] . ' list-group-item d-flex justify-content-between align-items-center">'
                            . $data['title'] . '
                                <div>
                                    <a href="/inProgress?id=' . $data['id'] . '" class="btn btn-outline-success">In progress</a>
                                    <a href="/pending?id=' . $data['id'] . ' " class="btn btn-outline-success">Pending</a>
                                </div>                                
                            </li>';
                        ...
                        echo '<li class="' . $data['status'] . ' list-group-item d-flex justify-content-between align-items-center">'
                            . $data['title'] . '
                                <div>
                                    <a href="/inProgress?id=' . $data['id'] . '" class="btn btn-outline-success">In progress</a>
                                    <a href="/complete?id=' . $data['id'] . ' " class="btn btn-outline-success">Complete</a>
                                </div>                                
                            </li>';
